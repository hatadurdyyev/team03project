...
public class US_03_API_StepDefs {

    Response response;

    @Given("send get request by subject {string}")
    public void send_get_request_by_subject (String subject) {

        spec2.pathParams("first","contactMessages","second","searchBySubject").queryParam("subject",subject);
